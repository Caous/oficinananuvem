...
import APIs.Apis;
import static com.thinkcode.models.Criptografia.decrypt;
...
public class UsuarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (logado) {
            ...
            if (tarefa != null) {
                if (!tarefa.equals("Cancelar")) {
                    ...
                    if (tarefa.equals("Excluir")) {
                        ...
                        url = "/gerenciamentoUsuarios.jsp";
                        usuarioController.Delete(Integer.parseInt(id), Access.Id_USUARIO(cookies));
                    }
                    //Fim exclusão
                    ...
                    if (request.getParameter("cpf") != null && request.getParameter("rg") != null && request.getParameter("email") != null && request.getParameter("email") != null) {
                        ...
                        usuario.setUserInclusao(Access.Id_USUARIO(cookies));
            ...
            List<PerfilModel> perfis = perfilController.listAll(null);
