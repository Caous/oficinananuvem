    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div class="main-content">
                <div class="col-lg-12">
                    <p>
                    <h4 style="color: rgb(118, 168, 88)"><i class="fa fa-registered" aria-hidden="true"></i> Registro de Vendas</h4>
                                    ...
                                    <div id="fuelux-wizard-container">
                                        ...
                                        <div class="step-content pos-rel">
                                            ...
                                            <div class="step-pane" data-step="2">
                                                ...
                                                <div class="col-lg-12 " style="max-width: 500px; border: 1px solid #ddd;border-radius: 5px;">
