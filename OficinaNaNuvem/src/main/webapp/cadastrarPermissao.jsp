            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        <form action="PermissaoServlet" method="POST"> 
                            <div class="row">                               
                                <div class="col-lg-12">
                                    <p>
                                    <h4>Cadastro de Permissão <i class="fa fa-shield" aria-hidden="true"></i> </h1>
                                        <hr>
                                        </p>
                                        </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="widget-box">
                                                        <div class="widget-header">
                                                            <h4 class="widget-title center">Informações de Permissão</h4>
                                                            ...
                                                            <div class="widget-main">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        ...
                                                                        <select class="" style="width: 100%;" name="pagina" required>
                                                                            <option></option>
                                                                            <c:forEach var="menu" items="${menus}">
                                                                                <option value="${menu.idMenu}">
                                                                                    ${menu.pagina} (${menu.descricao}) 
                                                                                </option>
                                                                            </c:forEach>
                                                                        </select>
                                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <a href="PermissaoServlet"  class="btn btn-sm btn-danger right" style="float: right;">
