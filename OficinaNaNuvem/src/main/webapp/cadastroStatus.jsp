                                            ...
                                            <div class="widget-main">
                                                <div class="form-group">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select class="form-group" style="width: 100%;" name="statusSelecionado">
                                                            <option></option> 
                                                ...
                                                <label>  
                                                    ...
                                                    <button class="btn btn-sm btn-info "
                                                            style="float: right; margin-right: 2px;" type="submit" name="tarefa"  value="atualizando">
                                                        Alterar &nbsp; <i class="ace-icon glyphicon glyphicon-edit"></i>
                                                    </button>
                                        ...
                                        <tbody>
                                            <c:forEach var="relatorio" items="${relatorio}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" disabled checked="${relatorio.sistema}"> Ecommerce

                                                    </td>
                                                    <td>
                                                        ${relatorio.metodoPagamento}
                                                    </td>
                                            ...
                                            <input type="text" value="${relatorio.idVenda}" style="display:none" name="idVenda"/>
                                        </c:forEach>
