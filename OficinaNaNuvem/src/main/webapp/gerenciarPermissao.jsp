            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="col-lg-12">
                            <p>
                            <h4 style="color: rgb(118, 168, 88)"><i class="fa fa-shield" aria-hidden="true"></i> Gerenciamento de Permissão</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="widget-box">
                                    ...
                                    <form method="POST" action="PermissaoServlet">
                                            ...
                                            <div class="widget-main">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select class="form-group" style="width: 100%;" name="filtroPagina">
                                                            <option></option>
                                                ...
                                                <br> &nbsp;
                                                <br> &nbsp;
                                                <label>  <a class="btn btn-sm btn-success " href="PermissaoServlet?tarefa=Cadastrando"
                                                            style="float: right; margin-right: 2px;">
                                                        Nova Permissão &nbsp; <i class="ace-icon glyphicon glyphicon-save"></i>
                                                    </a>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="permissao" items="${permissoes}">
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">${permissao.idPermissao}  </td>
                                                <td>
                                                    ${permissao.perfil}
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <button class="btn btn-xs btn-info btn-edit" value="${permissao.idPermissao}" onclick="window.display(${permissao.idPermissao})" >
                                                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                        </button>

                                                        <button class="btn btn-xs btn-danger" value="${permissao.idPermissao}" onclick="window.delete(${permissao.idPermissao})">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Seu permissão será excluída</p>
                                    </div>
