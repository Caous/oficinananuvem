            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="col-lg-12">
                            <p>
                            <h4 style="color: rgb(118, 168, 88)"><i class="fa fa-wrench" aria-hidden="true"></i> Gerenciamento de Status de Venda</h4>
                        ...
                        <form method="POST" action="StatusVendaServlet">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="widget-box">
                                                <div class="widget-header">
                                                    <h4 class="widget-title center">Informações do Status</h4>
                                                ...
                                                <div class="widget-body">
                                                    <div class="widget-main">
                                                        <div class="form-group">
                                                            <div class="col-lg-6">
                                                                <label for="number-button" class="block">Título</label>
                                                                <input type="text" id="form-field-1-1" placeholder="Título" class="form-control" name="titulo" required value="${propStatus.status}"/>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <label for="number-button" class="block">Descrição</label>
                                                                <input type="text" id="form-field-1-1" placeholder="Descrição" class="form-control" name="descricao" required value="${propStatus.descricao}"/>
                                                            </div>                                                                    
                                                        ...
                                                        <label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <a href="MenuServlet"  class="btn btn-sm btn-danger right" style="float: right;">
                                                                        Cancelar &nbsp;<i class="ace-icon fa fa-close"></i>
                                                                    </a>
                                                                    <c:choose>
                                                                        <c:when test= "${empty tarefa}">
                                                                            <button type="submit" class="btn btn-sm btn-success" style="float: right; margin-right: 2px;" name="tarefa" value="registrar">
                            ...
                            <input type="text" name="idStatus" value="${propStatus.id_status}" style="display:none;"/>
