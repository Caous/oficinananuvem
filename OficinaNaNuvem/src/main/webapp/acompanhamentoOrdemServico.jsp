            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="col-lg-12">
                            <p>
                            <h4 style="color: rgb(118, 168, 88)"><i class="fa fa-car" aria-hidden="true"></i> Relatórios de Ordens de Serviço</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                <div class="widget-box">
                                    ...
                                    <form method="POST" action="OrdemServicoServlet?tarefa=Relatorio">
                                    ...
                                    <tbody>
                                        <c:forEach var="relatorio" items="${relatorio}">
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">${relatorio.idOrdemServico}  </td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <button class="btn btn-xs btn-success btn-edit" value="${relatorio.idOrdemServico}" onclick="window.displayRelatorio(${relatorio.idOrdemServico})" >
                                                            <i class="ace-icon fa fa-server bigger-120"></i>
                                                        </button>
                                                        <button class="btn btn-xs btn-info btn-edit" value="${relatorio.idOrdemServico}" onclick="window.displaymessage(${relatorio.idOrdemServico})" >
                                                            <i class="ace-icon fa fa-product-hunt bigger-120"></i>
                                                        </button>
                                                        <button class="btn btn-xs btn-warning btn-edit" value="${relatorio.idOrdemServico}" onclick="window.displayNF(${relatorio.idOrdemServico})" >
...
// Loop over the array
                                                                ...
                                                                window.displayRelatorio = function (user)
                                                                {
                                                                    $.ajax({
                                                                        url: "ModalServlet",
                                                                        data: {
...
// Loop over the array
                                                                ...
                                                                window.displayNF = function (user)
                                                                {
                                                                    window.open("OrdemServicoServlet?tarefa=NF&id=" + user, '_blank');
                                                                }
