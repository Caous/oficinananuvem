            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="col-lg-12">
                            <p>
                            <h4 style="color: rgb(118, 168, 88)"><i class="fa fa-wrench" aria-hidden="true"></i> Gerenciamento de Produtos</h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class=" btn-group">
                                                        ...
                                                        <a class="btn btn-xs btn-success" target="_blank" href="detalhes-produto?idProduto=${produto.getIdProduto()}"><i class="ace-icon fa fa-eye bigger-120"></i></a>
