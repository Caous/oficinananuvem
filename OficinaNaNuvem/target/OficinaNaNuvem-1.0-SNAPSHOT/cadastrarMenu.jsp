                    ...
                    <div class="page-content">
                        <form action="MenuServlet" method="POST"> 
                            <div class="row">                               
                                <div class="col-lg-12">
                                    <p>
                                    <h4>Cadastro de Menu <i class="fa fa-bars" aria-hidden="true"></i> </h1>
                                        <hr>
                                        </p>
                                        </div>
                                                        ...
                                                        <div class="widget-body">
                                                            <div class="widget-main">
                                                                <div class="form-group">
                                                                    <div class="col-lg-3">
                                                                        <label for="number-button" class="block">Página</label>
                                                                        <input type="text" id="form-field-1-1" placeholder="Nome" class="form-control" name="pagina" required value="${dsPagina}"/>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <label for="number-button" class="block">Descrição</label>
                                                                        <input type="text" id="form-field-1-1" placeholder="Descrição" class="form-control" name="descricao" required value="${dsDescricao}"/>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <label for="number-button" class="block">Caminho da página</label>
                                                                        <input type="text" id="form-field-1-1" placeholder="Caminho da página" class="form-control" name="url" required value="${dsUrl}"/>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <label for="number-button" class="block">Tipo Menu</label>
                                                                        <select class="form-group" style="width: 100%;" name="tipoMenu">
                                                                            <option value="1">Relatório</option>
                                                                            <option value="2">Cadastro</option>
                                                                            <option value="3">Compras/Vendas</option>
                                ...
                                <div class="row">
                                    ...
                                    <input name="ID_MENU" style="display: none" value="${ID_MENU}"/>
                                </div>
