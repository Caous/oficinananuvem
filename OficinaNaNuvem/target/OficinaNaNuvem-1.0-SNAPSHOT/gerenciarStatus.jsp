            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="col-lg-12">
                            <p>
                            <h4 style="color: rgb(118, 168, 88)"><i class="fa fa-wrench" aria-hidden="true"></i> Gerenciamento de Status</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="widget-box">
                                    ...
                                    <form method="POST" action="StatusVendaServlet?tarefa=gerenciarStatus">
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                <div class="form-group">
                                                    <div class="col-lg-6">
                                                        <label for="number-button" class="block">Títulos</label>
                                                        <select class="form-group" style="width: 100%;" name="filtroTitulos">
                                                            <option></option> 
                                                            <c:forEach var="status" items="${filtrostatus}">                                                                 
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input name="filtroDescricao" type="text" class="form-control"/>                                                        
                                                    </div>
                                                    <label>
                                                        &nbsp;
                                                        &nbsp;
                                                ...
                                                <label>  <button class="btn btn-sm btn-success " href="StatusVendaServlet"
                                                                 style="float: right; margin-right: 2px;" name="tarefa" value="Cadastrando" type="submit">
                                                        Novo Status &nbsp; <i class="ace-icon glyphicon glyphicon-save"></i>
                                                    </button>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="tabelaProdutos" class="table table-hover display  table-striped table-bordered nowrap" style="width: 100%">
                                    ...
                                    <tbody>    
                                        <c:forEach var="status" items="${statusLista}">

                                            <tr>


                                                <td class="center">${status.id_status}  </td>
                                                <td>
                                                    ${status.status}
                                                </td>
                                                ...
                                                <td>
                                                    ${status.usrDsUsuarioInclusao}
                                                </td>                                                
                                                <td>
                                                    <div class="btn-group">                                                        
                                                        <a class="btn btn-xs btn-success btn-edit" href="StatusVendaServlet?tarefa=atualizandoStatusVenda&idStatus=${status.id_status}"  >
                                                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                        </a>
                                                        <a class="btn btn-xs btn-danger"   href="StatusVendaServlet?tarefa=excluindoStatusVenda&idStatus=${status.id_status}">
                            ...
                            <form method="POST" action="StatusVendaServlet" >
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h3 class="smaller lighter blue no-margin">Exclusão</h3>
                                    </div>

                                    <div class="modal-body">
                                        <p>Seu produto será excluído</p>
                                    </div>
