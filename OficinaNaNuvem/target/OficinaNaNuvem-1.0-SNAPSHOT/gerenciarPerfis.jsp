            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="col-lg-12">
                            <p>
                            <h4 style="color: rgb(118, 168, 88)"><i class="fa fa-user" aria-hidden="true"></i> Gerenciamento de Perfis</h4>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select class="form-group" style="width: 100%;" name="filtroTipoPerfil">
                                                            <option></option>
                                                            <c:forEach var="perfil" items="${perfisFiltro}">      
