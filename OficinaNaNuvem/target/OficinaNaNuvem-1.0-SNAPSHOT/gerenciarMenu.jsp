            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="col-lg-12">
                            <p>
                            <h4 style="color: rgb(118, 168, 88)"><i class="fa fa-bars" aria-hidden="true"></i> Gerenciamento de Menu</h4>
                                            ...
                                            <div class="widget-main">
                                                <div class="form-group">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select class="form-group" style="width: 100%;" name="tipoMenuFiltro">
                                                            <option></option>
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input type="text" name="filtroDescricao" class="form-control" >
                                                    </div>
                                                ...
                                                <br> &nbsp;
                                                <br> &nbsp;
                                                <label>  <a class="btn btn-sm btn-success " href="cadastrarMenu.jsp"
                                                            style="float: right; margin-right: 2px;">
                                                        Novo Menu &nbsp; <i class="ace-icon glyphicon glyphicon-save"></i>
                                                    </a>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="menu" items="${menus}">
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">${menu.idMenu}  </td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <button class="btn btn-xs btn-info btn-edit" value="${menu.idMenu}" onclick="window.display(${menu.idMenu})" >
                                                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                        </button>

                                                        <button class="btn btn-xs btn-danger" value="${menu.idMenu}" onclick="window.delete(${menu.idMenu})">
